                      ...
                      <div className="grid grid-cols-4 gap-1.5">
                        {[
                          ...
                          <button
                            ...
                            className="w-8 h-8 rounded-lg flex items-center justify-center transition-colors border border-zinc-300 dark:border-zinc-700 hover:border-zinc-500"
                            title={swatch.label}
                          >
                      ...
                      <div className="grid grid-cols-3 gap-1.5">
                        {[
                          ...
                          <button
                            ...
                            className="h-7 px-1.5 rounded-lg flex items-center justify-center text-[10px] font-medium border border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-500 transition-colors"
                            title={swatch.label}
                          >
