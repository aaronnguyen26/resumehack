...
export class LlmTailorService {
  ...
  public tailorBullets(
    ...
    // Tailor each bullet point strategically
  ...
  private optimizeBulletText(
    ...
    // Identify action verb replacements
    ...
    // If no weak verb found, ensure bullet starts with strong action verb
    ...
    // Intelligently inject target keyword if not present
